...
<head>
    ...
    <title>Admin Login — <?php echo e(setting('store_name', 'Crochet Store')); ?></title>
    ...
    <div class="card shadow-lg" style="width:100%;max-width:410px;">
        <div class="card-body p-4 p-md-5">
            <div class="text-center mb-4">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="<?php echo e(setting('store_name', 'Sistrella')); ?>" style="height:84px;width:auto;">
                <h4 class="fw-bold mt-3 mb-0">Admin Panel</h4>
                <p class="text-muted small"><?php echo e(setting('store_name', 'Crochet Store')); ?></p>
            </div>
            ...
            <form action="<?php echo e(route('admin.login.submit')); ?>" method="POST"><?php echo csrf_field(); ?>
                <div class="mb-3">
...
<?php /**PATH C:\Users\User\crochet-store\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>